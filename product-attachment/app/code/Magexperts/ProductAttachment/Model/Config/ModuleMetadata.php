...
namespace Magexperts\ProductAttachment\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_URL = 'https://www.Magexperts.com/';

    const MODULE_NAME = 'Magexperts_ProductAttachment';

    const VERSION_CACHE_KEY = 'Magexperts-productattachment-module-version';
