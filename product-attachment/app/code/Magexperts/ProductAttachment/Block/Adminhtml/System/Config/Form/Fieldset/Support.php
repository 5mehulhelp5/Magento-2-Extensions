...
namespace Magexperts\ProductAttachment\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Magexperts_ProductAttachment::system/config/form/fieldset/support.phtml';
