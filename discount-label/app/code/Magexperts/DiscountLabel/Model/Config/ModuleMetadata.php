...
namespace Magexperts\DiscountLabel\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_URL = 'https://www.Magexperts.com/magento2-product-discount-label.html';

    const MODULE_NAME = 'Magexperts_DiscountLabel';
