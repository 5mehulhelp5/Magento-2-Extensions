 ...
 */
namespace Magexperts\AdminUserGuide\Block\Adminhtml;

use Magento\Framework\View\Element\Template;
use Magexperts\AdminUserGuide\Model\XmlReader;
use Magexperts\AdminUserGuide\Model\Config;
...
class Help extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $data = [];
        if (!$this->authorization->isAllowed('Magexperts_AdminUserGuide::help')) {
            return $data;
        }
