...
namespace Magexperts\Cli\Block\Adminhtml;
...
class Form extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set(__('Command Line by Magexperts'));
    }
    ...
    public function getMagentoCommands()
    {
        ...
        if (!$this->authorization->isAllowed('Magexperts_Cli::admin')) {
