...
namespace Magexperts\Easypathhints\Block\System\Config\Form\Fieldset;
...
class Support extends \Magento\Backend\Block\Template implements \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Magexperts_Easypathhints::system/config/form/fieldset/support.phtml';
    ...
    public function getModuleVersion()
    {
        ...
        $v = "";
        if (isset($modules['Magexperts_Easypathhints'])) {
            $v = $modules['Magexperts_Easypathhints']['setup_version'];
        }
        return $v;
    }
}