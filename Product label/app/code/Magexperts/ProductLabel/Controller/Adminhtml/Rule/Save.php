...
use Magexperts\ProductLabel\Controller\Adminhtml\Rule;
...
class Save extends Rule
{
    ...
    /**
     * Before model save
     * @param  \Magexperts\ProductLabel\Model\Rule $model
                ...
                if (!empty($data[$key]['delete'])) {
                    ...
                    if (isset($data[$key][0]['name']) && isset($data[$key][0]['tmp_name'])) {
                        ...
                        $imageUploader = $this->_objectManager->get(
                            \Magexperts\ProductLabel\ImageUpload::class
                        );
                        ...
                        if (isset($data[$key][0]['url']) && false !== strpos($data[$key][0]['url'], '/media/')) {
                             ...
                             *    /media/.renditions/magexperts_product_label/a.png
                             *    http://crowdin.dev.magexperts.top/media/magexperts_product_label/tmp/a.png
                             */
