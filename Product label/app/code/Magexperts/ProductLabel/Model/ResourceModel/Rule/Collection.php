...
namespace Magexperts\ProductLabel\Model\ResourceModel\Rule;

use Magexperts\ProductLabel\Api\RuleCollectionInterface;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection  implements RuleCollectionInterface
{
    ...
    {
        $this->_init(
            \Magexperts\ProductLabel\Model\Rule::class,
            \Magexperts\ProductLabel\Model\ResourceModel\Rule::class
        );
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $tableName = $this->getTable('magexperts_product_label_rule_store');
    ...
    protected function _renderFiltersBefore()
    {
        foreach (['store', 'group'] as $key) {
            if ($this->getFilter($key)) {
                ...
                $this->getSelect()->join(
                    [$key . '_table' => $this->getTable('magexperts_product_label_rule_' . $key)],
