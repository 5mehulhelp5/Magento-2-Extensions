...
namespace Magexperts\ProductLabel\Model\ResourceModel;
 ...
 * Class Rule
 */
class Rule extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb implements \Magexperts\ProductLabel\Api\RuleResourceModelInterface
{
    /**
    ...
    {
        return $this->_lookupIds($ruleId, 'magexperts_product_label_rule_store', 'store_id');
    }
    ...
    {
        $this->_init('magexperts_product_label_rule', 'id');
    }
    ...
    protected function _afterSave(AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'magexperts_product_label_rule_store', 'store_id');
