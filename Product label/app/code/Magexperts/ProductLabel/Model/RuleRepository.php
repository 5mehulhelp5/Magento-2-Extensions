...
use Magexperts\ProductLabel\Api\Data\RuleInterfaceFactory;
use Magexperts\ProductLabel\Api\Data\RuleSearchResultsInterfaceFactory;
use Magexperts\ProductLabel\Api\RuleRepositoryInterface;
use Magexperts\ProductLabel\Api\RuleResourceModelInterface as ResourceRule;
use Magexperts\ProductLabel\Api\RuleCollectionInterfaceFactory as RuleCollectionFactory;
 ...
 * @package Magexperts\ProductLabel\Model
 */
class RuleRepository implements RuleRepositoryInterface
{
     ...
     */
    public function save(\Magexperts\ProductLabel\Api\Data\RuleInterface $rule)
    {
        try {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \Magexperts\ProductLabel\Api\Data\RuleInterface::class
        );
     ...
     */
    public function delete(\Magexperts\ProductLabel\Api\Data\RuleInterface $rule)
    {
        try {
