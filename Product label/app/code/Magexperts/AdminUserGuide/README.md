# [Magento 2 Admin User Guide Extension](https://magexperts.com/) by Magexperts

[![Total Downloads](https://poser.pugx.org/magexperts/module-admin-user-guide/downloads)](https://packagist.org/packages/magexperts/module-admin-user-guide)
[![Latest Stable Version](https://poser.pugx.org/magexperts/module-admin-user-guide/v/stable)](https://packagist.org/packages/magexperts/module-admin-user-guide)
...
## Installation Method 1 - Installing via composer
  ...
  * Run command: composer require magexperts/module-admin-user-guide

  

## Installation Method 2 - Installing using archive
  * Download [ZIP Archive](https://github.com/magexperts/module-admin-user-guide/archive/refs/heads/main.zip)
  * Extract files
  * In your Magento 2 root directory create folder app/code/Magexperts/AdminUserGuide
...
[issue tracker](https://github.com/magexperts/module-admin-user-guide/issues).
