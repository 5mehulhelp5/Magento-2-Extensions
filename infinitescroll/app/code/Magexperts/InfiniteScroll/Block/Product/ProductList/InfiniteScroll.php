...
namespace Magexperts\InfiniteScroll\Block\Product\ProductList;
...
use Magexperts\InfiniteScroll\Helper\Data as DataHelper;
...
class InfiniteScroll extends \Magento\Framework\View\Element\Template
{
     ...
     */
    const DEFAULT_LOADER_IMAGE_SRC = 'Magexperts_InfiniteScroll::images/ajax-loader.gif';
    ...
    public function getLoaderImageSrc()
    {
        ...
        $folderName = 'shopigo/catalog_infinite_scroll/loader';
