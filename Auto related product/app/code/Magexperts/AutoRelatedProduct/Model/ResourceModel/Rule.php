...
namespace Magexperts\AutoRelatedProduct\Model\ResourceModel;
...
use Magexperts\AutoRelatedProduct\Api\RelatedResourceModelInterface;
...
class Rule extends AbstractDb implements RelatedResourceModelInterface
{
    ...
    {
        $this->_init('magexperts_autorp_rule', 'id');
    }
    ...
    protected function _beforeDelete(AbstractModel $object)
    {
        ...
        $tables = [
            'magexperts_autorp_index',
            'magexperts_autorp_rule_store'
        ];
    ...
    {
        return $this->_lookupIds($ruleId, 'magexperts_autorp_rule_store', 'store_id');
    }
    ...
    protected function _afterSave(AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'magexperts_autorp_rule_store', 'store_id');
    ...
    {
        $result =$this->_lookupIds($object->getId(), 'magexperts_autorp_index', 'related_ids');
