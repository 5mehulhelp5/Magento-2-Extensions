...
class Rule extends \Magento\Framework\Model\AbstractModel implements \Magexperts\AutoRelatedProduct\Api\Data\RuleInterface
{
    /**
     * Rule's Status
     */
     ...
     * @var string
     */
    protected $_eventPrefix = 'magexperts_arp_rule';
    ...
    {
        $this->_init(\Magexperts\AutoRelatedProduct\Api\RelatedResourceModelInterface::class);
    }
