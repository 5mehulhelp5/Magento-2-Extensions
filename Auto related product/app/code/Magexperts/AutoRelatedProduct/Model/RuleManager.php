...
use Magexperts\AutoRelatedProduct\Model\ActionValidator;
use Magexperts\AutoRelatedProduct\Api\Data\RuleInterface;
...
class RuleManager
{
    ...
    /**
     * @var \Magexperts\AutoRelatedProduct\Model\ActionValidator
     */
     ...
     * @param \Magexperts\AutoRelatedProduct\Model\ActionValidator $ruleValidator
     */
    ...
    (
        ...
        \Magexperts\Community\Api\GetCategoryByProductInterface $getCategoryByProduct = null
    ) {
        ...
        $this->getCategoryByProduct = $getCategoryByProduct ?:\Magento\Framework\App\ObjectManager::getInstance()
            ->get(\Magexperts\Community\Api\GetCategoryByProductInterface::class);
    }
