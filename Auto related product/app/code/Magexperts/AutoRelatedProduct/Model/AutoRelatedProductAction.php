...
use Magexperts\Community\Model\Magento\Rule\Model\Condition\Sql\Builder;
use Magento\CatalogRule\Model\RuleFactory;
use Magento\Framework\Exception\LocalizedException;
use Magento\Catalog\Model\ResourceModel\Product\CollectionFactory;
use Magento\Framework\App\ResourceConnection;
use Magexperts\Community\Api\GetParentProductIdsInterface;
...
class AutoRelatedProductAction
{
    ...
    public function __construct(
        ...
        if ($this->moduleManager->isEnabled('Magexperts_DynamicProductAttributes')) {
            $this->validationFilter =
                \Magento\Framework\App\ObjectManager::getInstance()->get('Magexperts\DynamicProductAttributes\Api\AddCustomValidationFiltersInterface');
        }
    }
    ...
    public function execute()
    {
        ...
        $tableNameArpIndex = $this->resourceConnection->getTableName('magexperts_autorp_index');
