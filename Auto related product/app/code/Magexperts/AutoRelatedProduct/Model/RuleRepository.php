...
use Magexperts\AutoRelatedProduct\Api\Data\RuleInterfaceFactory;
use Magexperts\AutoRelatedProduct\Api\Data\RuleSearchResultsInterfaceFactory;
use Magexperts\AutoRelatedProduct\Api\RuleRepositoryInterface;
use Magexperts\AutoRelatedProduct\Api\RelatedResourceModelInterface as ResourceRule;
use Magexperts\AutoRelatedProduct\Api\RelatedCollectionInterfaceFactory as RuleCollectionFactory;
...
class RuleRepository implements RuleRepositoryInterface
{
     ...
     */
    public function save(\Magexperts\AutoRelatedProduct\Api\Data\RuleInterface $rule)
    {
        try {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \Magexperts\AutoRelatedProduct\Api\Data\RuleInterface::class
        );
     ...
     */
    public function delete(\Magexperts\AutoRelatedProduct\Api\Data\RuleInterface $rule)
    {
        try {
