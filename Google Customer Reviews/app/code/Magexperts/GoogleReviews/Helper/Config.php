...
namespace Magexperts\GoogleReviews\Helper;

use Magento\Framework\App\Helper\AbstractHelper;
use Magento\Framework\App\Helper\Context;
use Magento\Store\Model\ScopeInterface;
use Magexperts\GoogleReviews\Helper\CustomDeliveryTime;

class Config extends AbstractHelper
{
    const MODULE_ENABLED_PATH = 'magexperts_google_reviews/general/enabled';
    const MERCHANT_ID_PATH = 'magexperts_google_reviews/general/merchant_id';
    const DELIVERY_OFFSET_PATH = 'magexperts_google_reviews/general/delivery_time';

    const SURVEY_ALL_CUSTOMERS_PATH = 'magexperts_google_reviews/survey/all_customers';
    const SURVEY_CUSTOMER_GROUPS_PATH = 'magexperts_google_reviews/survey/customer_groups';
    const SURVEY_LANGUAGE_PATH = 'magexperts_google_reviews/survey/language';
    const SURVEY_STYLE_PATH = 'magexperts_google_reviews/survey/style';

    const BADGE_ENABLED_PATH = 'magexperts_google_reviews/badge/enabled';
    const BADGE_POSITION_PATH = 'magexperts_google_reviews/badge/position';
    const BADGE_LANGUAGE_PATH = 'magexperts_google_reviews/badge/language';
