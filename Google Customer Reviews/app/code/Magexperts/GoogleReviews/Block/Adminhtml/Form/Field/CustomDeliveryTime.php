...
namespace Magexperts\GoogleReviews\Block\Adminhtml\Form\Field;

use Magexperts\GoogleReviews\Helper\CustomDeliveryTime as Helper;
...
class CustomDeliveryTime extends AbstractFieldArray
{
    ...
    protected $_template = 'Magexperts_GoogleReviews::system/config/form/field/array.phtml';
