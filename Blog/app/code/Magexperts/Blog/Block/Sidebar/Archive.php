 ...
 */
class Archive extends \Magexperts\Blog\Block\Post\PostList\AbstractList
{
    use Widget;
    ...
    public function getTimeUrl($time)
    {
        if ($this->getGroupBy() == 'year') {
            return $this->_url->getUrl(
                date('Y', $time),
                \Magexperts\Blog\Model\Url::CONTROLLER_ARCHIVE
            );
        }
    ...
    public function getTranslatedDate($time)
    {
        ...
        return \Magexperts\Blog\Helper\Data::getTranslatedDate($format, $time);
    }
