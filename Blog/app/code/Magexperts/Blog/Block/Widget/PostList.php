<?php
/**
 * Copyright © 2015 Ihor Vansach (ihor@magexperts.com). All rights reserved.
 ...
 */
class PostList extends \Magexperts\Blog\Block\Post\PostList\AbstractList implements \Magento\Widget\Block\BlockInterface
{
    /**
     * Block template file
     * @var string
     */
    protected $_defaultToolbarBlock = 'Magexperts\Blog\Block\Post\PostList\Toolbar';
    ...
    public function getTemplate()
    {
        if ($this->isFullHtml()) {
            ...
            return 'Magexperts_Blog::post/widget/ajax-blog.phtml';
        }
    }
