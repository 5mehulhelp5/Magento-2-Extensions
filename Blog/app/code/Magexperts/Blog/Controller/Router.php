...
namespace Magexperts\Blog\Controller;

use Magexperts\Blog\Model\Url;
use Magexperts\Blog\Api\UrlResolverInterface;
...
class Router implements \Magento\Framework\App\RouterInterface
{
    ...
    public function __construct(
        ...
        $this->urlResolver = $urlResolver ?: \Magento\Framework\App\ObjectManager::getInstance()->get(
            \Magexperts\Blog\Api\UrlResolverInterface::class
        );
    }
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        */
        ...
        $this->_eventManager->dispatch(
            'magexperts_blog_controller_router_match_before',
