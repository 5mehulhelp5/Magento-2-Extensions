...
namespace Magexperts\Blog\Model\ResourceModel\Category;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init(\Magexperts\Blog\Model\Category::class, \Magexperts\Blog\Model\ResourceModel\Category::class);
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('magexperts_blog_category_store')],
