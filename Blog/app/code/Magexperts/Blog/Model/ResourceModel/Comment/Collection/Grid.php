...
namespace Magexperts\Blog\Model\ResourceModel\Comment\Collection;

use Magexperts\Blog\Model\ResourceModel\Comment\Collection;
...
class Grid extends Collection
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()
            ->joinLeft(
                ['post' => $this->getTable('magexperts_blog_post')],
