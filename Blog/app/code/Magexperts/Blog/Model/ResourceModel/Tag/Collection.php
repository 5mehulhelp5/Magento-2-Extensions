...
namespace Magexperts\Blog\Model\ResourceModel\Tag;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init(\Magexperts\Blog\Model\Tag::class, \Magexperts\Blog\Model\ResourceModel\Tag::class);
    ...
    {
        return $this
            ->addFieldToFilter('main_table.is_active', \Magexperts\Blog\Model\Tag::STATUS_ENABLED);
    }
    /**
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $tableName = $this->getTable('magexperts_blog_tag_store');
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('magexperts_blog_tag_store')],
