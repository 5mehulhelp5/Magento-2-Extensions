 ...
 * Category model
 *
 * @method \Magexperts\Blog\Model\ResourceModel\Category _getResource()
 * @method \Magexperts\Blog\Model\ResourceModel\Category getResource()
...
class Category extends \Magento\Framework\Model\AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'magexperts_blog_category';
    ...
    {
        $this->_init(\Magexperts\Blog\Model\ResourceModel\Category::class);
