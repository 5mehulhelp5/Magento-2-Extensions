 ...
 * Post model
 *
 * @method \Magexperts\Blog\Model\ResourceModel\Post _getResource()
 * @method \Magexperts\Blog\Model\ResourceModel\Post getResource()
...
class Post extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
     ...
     */
    const BASE_MEDIA_PATH = 'magexperts_blog';
     ...
     * @var string
     */
    protected $_eventPrefix = 'magexperts_blog_post';
    ...
    /**
     * @var \Magexperts\Blog\Model\ResourceModel\Tag\Collection
     */
    ...
    /**
     * @var \Magexperts\Blog\Model\ImageFactory
     */
    ...
    /**
     * @var \Magexperts\Blog\Api\AuthorRepositoryInterface|mixed
     */
    protected $authorRepository;

    /**
     * @var \Magexperts\Blog\Api\CategoryRepositoryInterface|mixed
     */
     ...
     * @param array $data
     * @param \Magexperts\Blog\Api\AuthorRepositoryInterface|null $authorRepository
    ...
    public function __construct(
        ...
        Url $url,
        \Magexperts\Blog\Model\ImageFactory $imageFactory,
        ...
        array $data = [],
        \Magexperts\Blog\Api\AuthorRepositoryInterface $authorRepository = null,
        ...
        $this->authorRepository = $authorRepository ?: \Magento\Framework\App\ObjectManager::getInstance()->get(
            \Magexperts\Blog\Api\AuthorRepositoryInterface::class
        );
    ...
    {
        $this->_init(\Magexperts\Blog\Model\ResourceModel\Post::class);
    ...
    public function getIdentities()
    {
        ...
        if ($allIdentitiesFlag || $isChangedCategories) {
            ...
            foreach ($changedCategories as $categoryId) {
                $identities[] = \Magexperts\Blog\Model\Category::CACHE_TAG . '_' . $categoryId;
            }
        }
    ...
    /**
     * Retrieve post tags
     * @return \Magexperts\Blog\Model\ResourceModel\Tag\Collection
     */
    ...
    public function getRelatedPosts()
    {
        if (!$this->hasData('related_posts')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('magexperts_blog_post_relatedpost')],
    ...
    public function getRelatedProducts()
    {
        if (!$this->hasData('related_products')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('magexperts_blog_post_relatedproduct')],
