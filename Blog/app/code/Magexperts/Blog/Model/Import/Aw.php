    ...
    public function execute()
    {
        ...
        foreach ($result as $data) {
            ...
            $data = [
                ...
                'featured_img' => !empty($data['featured_image']) ? 'magexperts_blog/' . $data['featured_image'] : '',
            ];
            $data['identifier'] = trim(strtolower($data['identifier']));
                ...
                foreach ($resultComments as $comments) {
                    ...
                    $commentData = [
                        ...
                        'status' => ($comments['status'] == 2) ?
                            \Magexperts\Blog\Model\Config\Source\CommentStatus::APPROVED :
                            \Magexperts\Blog\Model\Config\Source\CommentStatus::NOT_APPROVED,
