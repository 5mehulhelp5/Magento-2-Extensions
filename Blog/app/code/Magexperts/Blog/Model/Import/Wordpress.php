        ...
        foreach ($result as $data) {
            ...
            foreach ($result2 as $data2) {
                if ($data2['featured_img']) {
                    $data['featured_img'] = \Magexperts\Blog\Model\Post::BASE_MEDIA_PATH . '/' . $data2['featured_img'];
                    break;
                }
            }
                    ...
                    if ($data2['featured_img']) {
                        ...
                        if (is_array($tmpArr)) {
                            foreach ($tmpArr as $item) {
                                ...
                                if ($item) {
                                    $data['featured_img'] = \Magexperts\Blog\Model\Post::BASE_MEDIA_PATH . '/' . $item;
                                    break 2;
                                }
            ...
            */
            ...
            $content = preg_replace(
                ...
                'src="$4{{media url="magexperts_blog$6$8"}}$9"',
                $content
            );
            ...
            try {
                ...
                foreach ($resultComments as $comments) {
                    ...
                    $commentData = [
                        ...
                        'status' => \Magexperts\Blog\Model\Config\Source\CommentStatus::APPROVED,
                        'author_type' => \Magexperts\Blog\Model\Config\Source\AuthorType::GUEST,
