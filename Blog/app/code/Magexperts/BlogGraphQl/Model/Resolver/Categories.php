...
use Magexperts\Blog\Api\CategoryRepositoryInterface;

/**
 * Class Categories
 * @package Magexperts\BlogGraphQl\Model\Resolver
 */
class Categories implements ResolverInterface
{
    ...
    public function resolve(
        ...
        $searchCriteria = $this->searchCriteriaBuilder->build('magexperts_blog_categories', $args);
