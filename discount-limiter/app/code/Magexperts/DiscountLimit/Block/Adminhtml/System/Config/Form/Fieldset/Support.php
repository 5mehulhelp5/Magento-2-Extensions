...
namespace Magexperts\DiscountLimit\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Magexperts_DiscountLimit::system/config/form/fieldset/support.phtml';
