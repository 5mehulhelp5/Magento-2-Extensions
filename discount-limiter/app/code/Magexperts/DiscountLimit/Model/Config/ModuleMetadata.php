...
namespace Magexperts\DiscountLimit\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const MODULE_NAME = 'Magexperts_DiscountLimit';

    const VERSION_CACHE_KEY = 'Magexperts-discountlimit-module-version';
