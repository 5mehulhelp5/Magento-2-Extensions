...
namespace Magexperts\StorePricing\Block\Adminhtml\System\Config\Form\Fieldset;

use Magento\Backend\Block\Template;
use Magento\Backend\Block\Template\Context;
use Magento\Framework\Data\Form\Element\AbstractElement;
use Magexperts\StorePricing\Model\Config\ModuleMetadata;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Magexperts_StorePricing::system/config/form/fieldset/support.phtml';
