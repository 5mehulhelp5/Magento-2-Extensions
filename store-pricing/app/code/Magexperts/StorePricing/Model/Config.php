...
namespace Magexperts\StorePricing\Model;
...
class Config implements ConfigInterface
{
    ...
    const XML_PATH_ENABLED = 'Magexperts_storepricing/general/enabled';
    const XML_PATH_DEBUG = 'Magexperts_storepricing/general/debug';
