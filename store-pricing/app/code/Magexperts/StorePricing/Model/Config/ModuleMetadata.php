...
namespace Magexperts\StorePricing\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_URL = 'https://www.Magexperts.com/magento2-store-view-pricing.html';

    const MODULE_NAME = 'Magexperts_StorePricing';

    const VERSION_CACHE_KEY = 'Magexperts-storepricing-module-version';
