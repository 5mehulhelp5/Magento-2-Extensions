...
namespace Magexperts\GoToCatalog\Block\Adminhtml\System\Config\Form\Fieldset;

use Magento\Backend\Block\Template;
use Magento\Backend\Block\Template\Context;
use Magento\Framework\Data\Form\Element\AbstractElement;
use Magexperts\GoToCatalog\Model\Config\ModuleMetadata;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Magexperts_GoToCatalog::system/config/form/fieldset/support.phtml';
