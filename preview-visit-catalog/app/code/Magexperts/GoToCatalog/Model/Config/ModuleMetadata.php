...
namespace Magexperts\GoToCatalog\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_URL = 'https://www.Magexperts.com/magento2-go-to-catalog.html';

    const MODULE_NAME = 'Magexperts_GoToCatalog';
