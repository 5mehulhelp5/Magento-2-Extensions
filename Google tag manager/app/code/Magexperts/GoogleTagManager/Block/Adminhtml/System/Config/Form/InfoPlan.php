...
abstract class InfoPlan extends \Magexperts\Community\Block\Adminhtml\System\Config\Form\Info
{
    /**
     * @return string
     */
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if ($text = $this->getText()) {
            ...
            $html .= $text . ' <a style="color: #ef672f; text-decoration: underline;" href="https://magexperts.com/magento-2-google-tag-manager/pricing?utm_source=gtm_config&utm_medium=link&utm_campaign=regular" target="_blank">Read more</a>.';
            $html .= '</div>';
        }
                            ...
                            $(this).click(function(){
                                alert({
                                    ...
                                    buttons: [{
                                        ...
                                        click: function () {
                                            window.open("https://magexperts.com/magento-2-google-tag-manager/pricing?utm_source=gtm_config&utm_medium=link&utm_campaign=regular");
                                        }
                                    }]
                                });
                            });
