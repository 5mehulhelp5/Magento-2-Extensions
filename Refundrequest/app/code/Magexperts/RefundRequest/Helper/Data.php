...
class Data extends AbstractHelper
{
     ...
     */
    const MAGEXPERTS_CONFIG_ENABLE_MODULE = 'bss_refundrequest/bss_refundrequest_general/enable';

    /**
     * Config for order refund
     * MAGEXPERTS_CONFIG_ORDER_REFUND
     */
    const MAGEXPERTS_CONFIG_ORDER_REFUND = 'bss_refundrequest/bss_refundrequest_general/canrefund';

    /**
     * Config for title popup
     * MAGEXPERTS_CONFIG_TITLE_POPUP
     */
    const MAGEXPERTS_CONFIG_POPUP_TITLE = 'bss_refundrequest/bss_refundrequest_config/popup_title';

    /**
     * Config for enable dropdown
     * MAGEXPERTS_CONFIG_ENABLE_DROPDOWN
     */
    const MAGEXPERTS_CONFIG_ENABLE_DROPDOWN = 'bss_refundrequest/bss_refundrequest_config/enable_dropdown';

    /**
     * Config for dropdown title
     * MAGEXPERTS_CONFIG_DROPDOWN_TITLE
     */
    const MAGEXPERTS_CONFIG_DROPDOWN_TITLE = 'bss_refundrequest/bss_refundrequest_config/dropdown_title';

    /**
     * Config for enable option
     * MAGEXPERTS_CONFIG_ENABLE_OPTION
     */
    const MAGEXPERTS_CONFIG_ENABLE_OPTION = 'bss_refundrequest/bss_refundrequest_config/enable_option';

    /**
     * Config for option title
     * MAGEXPERTS_CONFIG_OPTION_TITLE
     */
    const MAGEXPERTS_CONFIG_OPTION_TITLE = 'bss_refundrequest/bss_refundrequest_config/option_title';

    /**
     * Config for detail title
     * MAGEXPERTS_CONFIG_DETAIL_TITLE
     */
    const MAGEXPERTS_CONFIG_DETAIL_TITLE = 'bss_refundrequest/bss_refundrequest_config/detail_title';

    /**
     * Config for config title
     * MAGEXPERTS_CONFIG_TITLE
     */
    const MAGEXPERTS_CONFIG_POPUP_DESCRIPTION = 'bss_refundrequest/bss_refundrequest_config/popup_description';

    /**
     * Config for admin email
     * MAGEXPERTS_CONFIG_ADMIN_EMAIL
     */
    const MAGEXPERTS_CONFIG_ADMIN_EMAIL = 'bss_refundrequest/bss_refundrequest_email_config/admin_email';

    /**
     * Config for email template
     * MAGEXPERTS_CONFIG_EMAIL_TEMPLATE
     */
    const MAGEXPERTS_CONFIG_EMAIL_TEMPLATE = 'bss_refundrequest/bss_refundrequest_email_config/email_template';

    /**
     * Config for email sender
     * MAGEXPERTS_CONFIG_EMAIL_SENDER
     */
    const MAGEXPERTS_CONFIG_EMAIL_SENDER = 'bss_refundrequest/bss_refundrequest_email_config/email_sender';

    /**
     * Config for accept email
     * MAGEXPERTS_CONFIG_ACCEPT_EMAIL
     */
    const MAGEXPERTS_CONFIG_ACCEPT_EMAIL = 'bss_refundrequest/bss_refundrequest_email_config/accept_email';

    /**
     * Config for reject email
     * MAGEXPERTS_CONFIG_REJECT_EMAIL
     */
    const MAGEXPERTS_CONFIG_REJECT_EMAIL = 'bss_refundrequest/bss_refundrequest_email_config/reject_email';
