...
namespace Magexperts\DisableRegistration\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_URL = 'https://www.Magexperts.com/magento2-disable-customer-registration.html';

    const MODULE_NAME = 'Magexperts_DisableRegistration';

    const VERSION_CACHE_KEY = 'Magexperts-disableregistration-module-version';
